...
$string['userstatsadvanced_contenidos_visualizados'] = 'Visited resources / total';
...
$string['legacy_scenario_frozen'] = 'Legacy data (course ended)';
$string['legacy_scenario_live'] = 'Live data (itop active)';
$string['legacy_scenario_own'] = 'Configurable Reports (own)';
$string['legacy_scenario_unknown'] = 'Unknown scenario';
$string['legacy_view_title'] = 'Legacy data viewer';
$string['legacy_breadcrumb'] = 'Legacy data';
$string['legacy_no_itop_data'] = 'This course has no data from the previous system. Redirecting to configurable reports.';
$string['legacy_no_data'] = 'No data available for this section.';
$string['legacy_readonly_notice'] = 'Read-only data — preserved for audit custody.';
$string['legacy_nav_label'] = 'Legacy data (audit)';
$string['legacy_tab_summary'] = 'Summary';
$string['legacy_tab_dedication'] = 'Dedication';
$string['legacy_tab_scorm'] = 'SCORM';
$string['legacy_tab_videoconf'] = 'Videoconference';
$string['legacy_tab_daily'] = 'Daily statistics';
$string['legacy_tab_values'] = 'Predefined values';
$string['legacy_summary_students'] = 'Students';
$string['legacy_summary_avgdedication'] = 'Average dedication';
$string['legacy_summary_coursehours'] = 'Course hours';
$string['legacy_summary_scorms'] = 'SCORM activities';
$string['legacy_summary_videoconf'] = 'Videoconf. records';
$string['legacy_summary_datarange'] = 'Data range';
$string['legacy_col_userid'] = 'User ID';
$string['legacy_col_firstname'] = 'First name';
$string['legacy_col_lastname'] = 'Last name';
$string['legacy_col_email'] = 'Email';
$string['legacy_col_dedication_seconds'] = 'Dedication (sec.)';
$string['legacy_col_dedication_formatted'] = 'Dedication';
$string['legacy_col_graceperiods'] = 'Grace periods';
$string['legacy_col_coursehours'] = 'Course hours';
$string['legacy_col_passhours'] = 'Pass hours';
$string['legacy_col_trackingmethod'] = 'Tracking method';
$string['legacy_col_timemodified'] = 'Last modified';
$string['legacy_col_scormname'] = 'SCORM name';
$string['legacy_col_scoid'] = 'SCO ID';
$string['legacy_col_attempt'] = 'Attempt';
$string['legacy_col_jointime'] = 'Join time';
$string['legacy_col_leavetime'] = 'Leave time';
$string['legacy_col_duration'] = 'Duration';
$string['legacy_col_stat'] = 'Statistic';
$string['legacy_col_value'] = 'Value';
$string['legacy_col_date'] = 'Date';
$string['legacy_col_reportname'] = 'Report name';
$string['legacy_export_heading'] = 'Export legacy data';
$string['legacy_export_dedication'] = 'Export dedication (Excel)';
$string['legacy_export_scorm'] = 'Export SCORM (Excel)';
$string['legacy_export_summary'] = 'Export summary (Excel)';
$string['legacy_export_metadata'] = 'Metadata';
$string['legacy_export_title'] = 'Legacy data report — Configurable Reports';
$string['legacy_export_scenario'] = 'Scenario';
$string['legacy_export_source'] = 'Data source';
$string['legacy_export_readonly'] = 'Read-only';
$string['legacy_export_course'] = 'Course';
$string['legacy_export_startdate'] = 'Start date';
$string['legacy_export_enddate'] = 'End date';
$string['legacy_export_students'] = 'Total students';
$string['legacy_export_avgdedication'] = 'Average dedication';
$string['legacy_export_coursehours'] = 'Course hours';
$string['legacy_export_firstrecord'] = 'First record';
$string['legacy_export_lastrecord'] = 'Last record';
$string['legacy_export_generated'] = 'Generated on';
$string['legacy_watermark'] = 'Legacy data preserved for custody — Exported on {$a}';
